...
def init():
    # 请求地址
    url = "https://uwf7de983aad7a717eb.youzy.cn/youzy.dms.datalib.api.v4.enrolldata.enter.college.search"
    ...
    headers = {
        ...
        "U-Sign": "940d4d8bc6dae94893dba3e3aa41daa6",
    ...
    # 请求参数
    data = {"provinceCode": 12, "collegeCode": "10003"}
